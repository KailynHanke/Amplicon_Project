...
# Write bash code to run MAFFT... DO CTRL+ALT+ENTER
# First provide the path to MAFFT
# Note to increase knit speed, changed "eval = FALSE"
...
In this document I made a phylogenetic tree so I can use it for phylogenetic community analyses like phylogenetic Hill Numbers and the UniFrac beta-diversity measures moving forward.
