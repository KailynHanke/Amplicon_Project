...
In this analysis document I will be combining my data into a phyloseq object and removing any contaminating ASVs. I will be using data from a 2020 paper titled: "Tracking the Dairy Microbiota from Farm Bulk Tank to Skimmed Milk Powder" (@mchughTrackingDairyMicrobiota2020). By analyzing this data I want to answer the broad research question: How does microbial diversity change throughout the skim milk powder manufacturing process?
...
In this document I combined my data into a phyloseq object and removed any contaminating ASVs that were chloroplasts or mitochondria. I evaluated (or tried to evaluate since there were no controls) for controls. I also checked for reverse complements and the sequencing depth.
