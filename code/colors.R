# Setting colors for environment_(materials)
environment_colors <- c(
  "Bulk Tank Milk" = "dodgerblue4",
  "Collection Tanker Milk" = "dodgerblue2",
  "Skimmed Milk Powder" = "#D9CC3C",
  "Skimmed Milk Silo" = "#A0E0BA",
  "Whole Milk Silo" = "#00ADA7",
  "Cream Silo" = "violetred")
...
phylum_colors <- c(
  ...
  Spirochaetota = "sienna3",
  Planctomycetota = "dodgerblue4",
  Proteobacteria_unclassified = "greenyellow",
  Thermodesulfobacteriota = "rosybrown1",
